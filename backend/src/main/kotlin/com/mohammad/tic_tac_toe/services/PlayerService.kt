...
import com.mohammad.tic_tac_toe.repo.PlayerRepo
import com.mohammad.tic_tac_toe.responses.PlayerConnected
...
class PlayerService(
    ...
    private fun generatePlayerName(id: String): String = "guest_${id.substring(0, 5)}"
}
