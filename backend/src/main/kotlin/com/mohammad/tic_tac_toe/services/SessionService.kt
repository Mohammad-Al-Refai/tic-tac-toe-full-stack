...
import com.mohammad.tec.tac_toe.responses.ActionResponse
import com.mohammad.tec.tac_toe.responses.GameError
...
class SessionService(
    ...
    fun sendError(session: WebSocketSession, message: String, requestId: String) {
        if (!session.isOpen) {
            return
        }
